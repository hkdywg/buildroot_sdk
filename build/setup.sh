...
function setup_build_env()
{
	...
	export BUILD_PATH BUILD_OUT_PATH UBOOT_BUILD_PATH KERNEL_BUILD_PATH ROOTFS_BUILD_PATH IMAGE_OUTPUT_PATH RAMDISK_OUTPUT_PATH
	export UBOOT_PATH KERNEL_PATH RAMDISK_PATH ROOTFS_PATH APPS_PATH PREBUILD_TOOLS_PATH
